    ...
    <div className="h-[300px] w-[350px] overflow-hidden rounded-[40px] border-2 shadow-lg transition-all hover:h-72 hover:w-80 hover:bg-stone-100">
      ...
      <div className="p-2">
        <h3 className="max-h-10 text-xl font-bold">
          Event 1 asdasdasdasdas sadasdas sad asd asd
        </h3>
        <div className="mt-5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-gray-500">E1-10</span>
            </div>
          </div>
          <div className="mt-6 flex items-center justify-center">
            ...
            <span className="ml-2 text-gray-500">Đơn vị tổ chức: HUTECH</span>
          </div>
        </div>
      </div>
    </div>
