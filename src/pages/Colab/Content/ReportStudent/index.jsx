...
const ReportStudent = () => {
  ...
  const [studentCodeList, setStudentCodeList] = useState([]); // Dữ liệu chi tiết sinh viên tham gia sự kiện
  const [textAreaValue, setTextAreaValue] = useState(""); // Dữ liệu danh sách mssv nhập vào từ textarea
  ...
  const handleShowResult = () => {
    if (textAreaValue === "") {
      alert("Vui lòng nhập danh sách mã số sinh viên");
      return;
    }
    const studentCodeList = textAreaValue
      .split("\n")
      .map((item) => item.trim())
      .filter((item) => item !== "");
      ...
      {studentCodeList.length === 0 && (
        <div>
            ...
            <div className="flex items-center space-x-1">
              ...
              <div>
                ...
                <p className="text-gray-500">
                  Bạn có thể tra cứu danh sách sinh viên tham gia các sự kiện
                  tại đây
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 rounded-md bg-white p-4 shadow-md">
            ...
            <p className="text-gray-500">
              1. Danh sách mã số sinh viên mà bạn muốn tra cứu (mỗi dòng khai
              báo là 1 mã số sinh viên, dòng nào khai báo sai hoặc MSSV không
              tồn tại thì hệ thống sẽ bỏ qua)
            </p>
            <textarea
              value={textAreaValue}
            ...
            <p className="mt-2 text-gray-500">
              2. Các sự kiện/hội thảo mà bạn muốn tra cứu (vui lòng chọn ít nhất
              1 sự kiện)
            </p>
