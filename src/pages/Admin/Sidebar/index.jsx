...
const Sidebar = () => {
  ...
  return (
    <div className="mt-2 h-screen w-64 overflow-y-auto rounded-xl bg-slate-100 p-4">
      <div>
        <h1
        ...
        <div
          className={`pl-4 transition-all duration-300 ${
            isSystemMenuOpen ? "max-h-fit opacity-100" : "max-h-0 opacity-0"
          } overflow-hidden`}
        >
          <Link
            to="/admin/user"
      ...
      <div>
        ...
        <div
          className={`pl-4 transition-all duration-300 ${
            isDataMenuOpen ? "max-h-fit opacity-100" : "max-h-0 opacity-0"
          } overflow-hidden`}
        >
          <Link
            to="/admin/event"
      ...
      <div>
        ...
        <div
          className={`pl-4 transition-all duration-300 ${
            isSearchMenuOpen ? "max-h-fit opacity-100" : "max-h-0 opacity-0"
          } overflow-hidden`}
        >
          <Link
