...
import DetailReportClass from "./DetailReportClass";
...
const ReportClass = () => {
  ...
  const handleShowResult = () => {
    if (eventList.filter((event) => event.checked).length === 0) {
  ...
  return (
    <div>
      {showDetail ? (
        <DetailReportClass eventList={eventList} onClose={handleCloseResult} />
      ) : (
        <div>
