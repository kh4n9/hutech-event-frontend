  ...
  const closeDeleteStudent = () => {
    ...
    return (
      <div>
        ...
        <table className="mt-4 w-full ">
            ...
            <tbody>
              {tableData.map((item) => (
                ...
                >
                  <td className="px-3 py-1 text-center">{item.id}</td>
                  <td className="px-3 py-1">{item.studentCode}</td>
                  <td className="px-3 py-1">{item.studentFullname}</td>
                  <td className="px-3 py-1">{item.studentClass}</td>
                  <td className="px-3 py-1 text-center">{item.isMonitor && "✔"}</td>
                  <td className="px-3 py-1">{item.studentPhone}</td>
                  <td className="px-3 py-1">{item.studentEmail}</td>
                  <td className="px-3 py-1 text-center">
                  <a
                    href={item.studentIDfacebook}
                    target="_blank"
        ...
        {showEditStudent && <EditStudent onClose={closeEditStudent} />}
        {/* Hiển thị DeleteStudent nếu showDeleteStudent = true */}
        {showDeleteStudent && <DeleteStudent onClose={closeDeleteStudent} />}
    </div>
